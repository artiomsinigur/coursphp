<?php
    class CompteBancaire
    {
        ...
        public static function incrementeCompteur()
        {
            self::$compteur++;
        }
    }
    ...
    {
        private static $compteurEpargne = 0;
        
        public function __construct($numC, $nom)
        {
            parent::__construct($numC, $nom);
            self::$compteurEpargne++;
        }
        
        public function calculeInteret($interet)
        {
            $this->solde = $this->solde * (1 + $interet);
        }
        
        public static function getCompteurEpargne()
        {
            return self::$compteurEpargne;
        }
        
        public static function getPourcentageComptesEpargnes()
        {
            return (self::$compteurEpargne / parent::$compteur * 100);
        }
