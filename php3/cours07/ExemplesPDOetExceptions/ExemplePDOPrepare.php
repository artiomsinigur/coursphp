<html>
    <body>
        <?php
            ...
            {
                echo "La page devrait recevoir un paramètre nommé idEquipe...";
            }
            else
            {
                $username = "root";
                ...
                try
                {
                    ...
                    $requete = "SELECT nom, prenom FROM joueur WHERE idEquipe = :idE";
                    $requetePreparee = $connexion->prepare($requete);
                    $requetePreparee->bindParam(":idE", $_GET["idEquipe"]);
                    ...
                    echo "Nombre de joueurs : " . $requetePreparee->rowCount();
